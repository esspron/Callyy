      ...
      <div className="bg-surface/50 border border-border rounded-2xl p-8 backdrop-blur-sm">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-surface px-2 text-textMuted">OR SIGN IN WITH</span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center space-y-4">
          ...
          <div>
            <Link to="/forgot-password" className="text-sm text-textMuted hover:text-textMain transition-colors">
