...
- **Architecture**: 
  ...
  - **Backend**: A lightweight Node.js/Express service (`backend/`) primarily for webhooks, heavy processing, and secret API calls.
...
- **Key Directories**:
  ...
  - `frontend/services/`: Contains API logic. `voicoryService.ts` handles Supabase data fetching.
